...
8. Podman Ecosystem
9. Podman-Exclusive Features
10. Practical Guidance
11. Migration Tips

---

## What is Containerization? (skip this:)
...
**But...** the growth need to be sustained

---

🤑 To stay alive Docker moved to subscription offering

![Docker Subscription license](assets/docker-license-splash.jpg)

---

### When Docker Desktop is free to use:
- Personal use
- Non-commercial open source
- Education (student, educators, training)
- Small business (<250 employees, 10 mil USD)

---

### When it is clearly not free:
- Entreprise
- Government entity

![Docker Public Sector Definition](assets/docker-public-sector-def.jpg)
...
- Fully [OCI](https://opencontainers.org/)-compliant
